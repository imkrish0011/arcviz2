      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded bg-[#0ea5e9] hover:bg-[#38bdf8] text-white font-medium text-xs tracking-wide transition-colors duration-150 shadow-lg"
            >
              Connect your cloud
          ...
          <div className="mt-12 pt-6 border-t border-white/[0.08] flex flex-wrap items-center gap-6 text-xs font-mono text-[#858a85]">
