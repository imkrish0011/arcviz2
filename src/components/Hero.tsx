...
export const Hero: React.FC = () => {
  const scrollToLifecycle = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-10 relative z-10 w-full">
        ...
        <div className="max-w-3xl mb-24 sm:mb-32 md:mb-44 lg:mb-52">
          ...
          <ScrollReveal direction="left" delay={50} distance="30px">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-white/[0.1] bg-[#0d100d]/80 backdrop-blur-md mb-6 shadow-sm">
          ...
          <ScrollReveal direction="left" delay={150} distance="40px">
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[80px] font-medium tracking-tight leading-[0.96] text-[#f1f2ee] mb-6 max-w-3xl">
          ...
          <ScrollReveal direction="left" delay={250} distance="40px">
            <p className="text-base sm:text-lg text-[#858a85] max-w-[680px] leading-relaxed mb-8 font-normal">
              From visual Day 0 design and pre-flight digital twin simulation to automated IaC provisioning and 24/7 live self-healing operations across AWS, Azure, and GCP.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal direction="left" delay={350} distance="40px">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-8">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-[#0ea5e9] hover:bg-[#38bdf8] text-white font-medium text-xs tracking-wide transition-all duration-200 shadow-[0_0_25px_rgba(14,165,233,0.35)] hover:shadow-[0_0_35px_rgba(56,189,248,0.5)] group font-mono"
              >
                Connect your cloud
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-[#0d100d]/80 hover:bg-white/[0.06] text-[#f1f2ee] border border-white/[0.1] hover:border-white/25 font-medium text-xs tracking-wide transition-all duration-200 backdrop-blur-sm font-mono cursor-pointer"
              >
