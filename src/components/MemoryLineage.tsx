  ...
  return (
    <section id="memory" className="py-36 md:py-48 border-t border-white/[0.06] bg-[#080a08] relative">
      <div className="max-w-[1240px] mx-auto px-6 md:px-10">
        ...
        {/* Multi-Dimensional Memory Architecture (No heavy outer box) */}
        <div className="space-y-10">
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3 border-b border-white/[0.06] gap-4 font-mono text-xs">
              <span className="text-[#f1f2ee] font-medium">Select Operational Query:</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch font-mono text-xs">
              ...
              <div className="lg:col-span-6 space-y-4">
                <div className="p-4 rounded border border-white/[0.08] bg-[#0d100d]/80 space-y-2">
                  ...
                  <div className="text-sm text-[#f1f2ee] font-medium italic">"{activeQuery.query}"</div>
                </div>

                <div className="p-4 rounded border border-white/[0.08] bg-[#050605] space-y-2 text-[11px]">
                  ...
                  <div>
                    <span className="text-[#f1f2ee] font-semibold block">{activeQuery.retrievedIncident}</span>
              ...
              <div className="lg:col-span-6 p-8 rounded-lg border border-white/[0.08] bg-[#0d100d]/90 flex flex-col justify-between shadow-2xl">
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="text-sm font-semibold text-[#f1f2ee]">
