...
import { Box, Compass, Sparkles, Radio } from 'lucide-react';
...
export const BuildAndConnect: React.FC = () => {
  ...
  return (
    <section id="build-connect" className="py-32 md:py-44 border-t border-white/[0.06] bg-[#080a08] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-[#38bdf8]/5 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-10 right-0 w-[450px] h-[450px] bg-[#10b981]/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-10 relative z-10">
        ...
        {/* Dual Stream Split Composition with Left & Right Side-Entrance */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
                ...
                <div className="space-y-6 pt-4">
                  ...
                  <div className="space-y-3 font-mono text-xs pt-2">
                    ...
                    <div 
                      ...
                      className={`flex items-center justify-between p-4 rounded-lg border transition-all cursor-pointer ${
                        activePoint === 2 
                          ? 'border-[#a855f7]/60 bg-[#a855f7]/10 text-[#f1f2ee] shadow-[0_0_20px_rgba(168,85,247,0.1)]' 
                          : 'border-white/[0.06] bg-[#0d100d]/70 text-[#858a85] hover:border-white/20'
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <span className="text-[#a855f7] font-semibold">03</span>
                        <span className="text-[#f1f2ee] font-medium">Multi-Cloud Deployment Engine</span>
                      </div>
                      <span className="text-[10px] text-[#a855f7] px-2 py-0.5 rounded bg-[#a855f7]/15">AWS • Azure • GCP</span>
                    </div>
                  </div>
                </div>
              ) : (
          ...
          {/* Right: Multi-Cloud Spatial Convergence & 3D Architectural Visual (Slide from Right) */}
          <div className="lg:col-span-6 relative">
            <ScrollReveal direction="right" delay={250} distance="50px">
              <div className="space-y-4 font-mono text-xs">
                {/* 3D Geometric Architectural Canvas Showcase (User Image Embedded) */}
                <div className="relative rounded-xl overflow-hidden border border-white/[0.1] bg-[#0d100d] shadow-2xl group">
                  <div className="relative h-56 sm:h-64 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 flex items-center gap-2 px-2.5 py-1 rounded-md bg-[#080a08]/80 backdrop-blur-md border border-white/[0.1] text-[10px] text-[#f1f2ee]">
                      <Box className="w-3.5 h-3.5 text-[#38bdf8]" />
                      <span>Spatial Canvas: 3D Topology Node Grid</span>
                    </div>

                    <div className="absolute top-4 right-4 flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#080a08]/80 backdrop-blur-md border border-white/[0.1] text-[10px] text-[#10b981]">
                      <Radio className="w-3 h-3 animate-ping" />
                      <span>Live Synced</span>
                    </div>

                    {/* Floating interactive coordinate markers */}
                ...
                {/* AWS Stream Card */}
                <div className="p-4 rounded-lg border border-white/[0.08] bg-[#0d100d]/80 backdrop-blur-md flex items-center justify-between shadow-lg hover:border-white/20 transition-colors">
                  <div className="flex items-center gap-3">
                ...
                <div className="p-5 rounded-xl border border-[#38bdf8]/40 bg-[#38bdf8]/10 backdrop-blur-md text-center shadow-[0_0_35px_rgba(56,189,248,0.15)] relative overflow-hidden group">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-lg border border-white/[0.08] bg-[#0d100d]/80 backdrop-blur-md flex items-center justify-between hover:border-white/20 transition-colors">
                    <div className="flex items-center gap-2.5">
                      <AzureIcon className="w-4 h-4 text-[#f1f2ee]" />
                      <span className="text-[#f1f2ee] text-xs">Azure</span>
                    </div>
                    <span className="text-[10px] text-[#10b981] px-1.5 py-0.2 rounded bg-[#10b981]/10">eastus</span>
                  </div>

                  <div className="p-3.5 rounded-lg border border-white/[0.08] bg-[#0d100d]/80 backdrop-blur-md flex items-center justify-between hover:border-white/20 transition-colors">
                    <div className="flex items-center gap-2.5">
                      <GcpIcon className="w-4 h-4 text-[#f1f2ee]" />
                      <span className="text-[#f1f2ee] text-xs">GCP</span>
                    </div>
                    <span className="text-[10px] text-[#10b981] px-1.5 py-0.2 rounded bg-[#10b981]/10">us-central1</span>
                  </div>
                </div>
              </div>
            </ScrollReveal>
