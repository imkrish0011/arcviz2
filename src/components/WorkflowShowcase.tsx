...
export const WorkflowShowcase: React.FC = () => {
  ...
  return (
    <section id="features" className="py-24 md:py-36 relative bg-[#030305]">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-white leading-tight">
            ...
            <span className="text-white/40">everything your team produces.</span>
          </h2>
        </div>
          ...
          {workflows.map((item, idx) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs sm:text-sm font-medium transition-all duration-200 ${
                activeTab === idx
                  ? 'bg-[#ff2d46] text-white font-semibold shadow-[0_0_20px_rgba(255,45,70,0.35)]'
                  : 'bg-white/[0.04] text-[#858b9c] hover:text-white hover:bg-white/[0.08] border border-white/10'
              }`}
            >
              {item.title.split(',')[0]}
            </button>
        ...
        <div className="relative rounded-2xl md:rounded-3xl bg-gradient-to-b from-[#0a0d16] to-[#08080c] border border-white/10 p-6 sm:p-10 md:p-14 overflow-hidden shadow-2xl transition-all duration-500">
          {/* Ambient Corner Red Glow */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#ff2d46]/10 blur-[130px] pointer-events-none" />

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            {/* Left Content Column */}
            <div className="lg:col-span-5 flex flex-col justify-between">
              <div>
                <div className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#ff2d46] tracking-widest uppercase mb-4 font-mono">
                ...
                <p className="text-sm sm:text-base text-[#858b9c] leading-relaxed mb-6">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 self-start px-6 py-3 rounded-full bg-gradient-to-r from-[#ff2d46] to-[#e11d48] hover:from-[#ff4d61] hover:to-[#ff2d46] text-white font-semibold text-xs uppercase tracking-wider transition-all duration-200 shadow-[0_0_20px_rgba(255,45,70,0.3)]"
              >
                Get started
            ...
            <div className="lg:col-span-7 relative">
              <div className="relative rounded-xl md:rounded-2xl overflow-hidden border border-white/10 bg-[#030305] p-2 shadow-2xl">
                <img
