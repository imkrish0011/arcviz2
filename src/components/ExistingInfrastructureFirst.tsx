...
export const ExistingInfrastructureFirst: React.FC = () => {
  ...
  return (
    <section id="existing-infra-first" className="py-32 md:py-44 border-t border-white/[0.06] bg-[#070907] relative overflow-hidden font-mono text-xs">
      {/* Background Grid */}
